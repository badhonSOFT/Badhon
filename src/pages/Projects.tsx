      ...
      <main className="pt-16 relative z-10">
        ...
        <section className="py-32 px-6 lg:px-8 relative overflow-hidden">
          <div className="mx-auto max-w-7xl text-center">
            ...
            <div className="mt-8 flex justify-center animate-scale-in" style={{ animationDelay: "0.6s" }}>
              <Badge variant="secondary" className="px-6 py-2 text-sm glass-card border-0 shadow-soft">
        ...
        <section className="px-6 lg:px-8 mb-16">
          <div className="mx-auto max-w-7xl">
            <div className="text-center mb-8 section-reveal" style={{ animationDelay: "0.4s" }}>
              <h2 className="text-2xl font-semibold text-foreground mb-2">Filter by Category</h2>
              <p className="text-muted-foreground">Explore different types of projects</p>
            </div>
            <div className="flex flex-wrap justify-center gap-4 section-reveal" style={{ animationDelay: "0.6s" }}>
              ...
              {categories.map((category, index) => (
                <Button
                  ...
                  className="rounded-full filter-button px-6 py-3 font-medium hover:scale-105 transition-all duration-300 shadow-soft hover:shadow-medium"
        ...
        <section className="px-6 lg:px-8 pb-32">
          <div className="mx-auto max-w-7xl">
            <div className="text-center mb-16 section-reveal" style={{ animationDelay: "0.5s" }}>
              <h2 className="text-3xl font-bold text-foreground mb-4 animate-heading-reveal">
                ...
                >
                  <CardContent className="p-8">
                    <div className="flex items-start justify-between mb-6">
                      <Badge 
                        variant="secondary" 
                        className="text-xs px-3 py-1.5 glass-card border-0 shadow-soft font-medium"
                      >
                        {project.category}
                      </Badge>
                      <a
                    ...
                    <h3 className="text-xl font-semibold text-foreground mb-4 group-hover:text-primary transition-colors animate-slide-in-left" style={{ animationDelay: `${index * 100 + 400}ms` }}>
                      {project.title}
                    </h3>
                    ...
                    <div className="flex flex-wrap gap-2 mb-8">
                      {project.tech.map((tech, techIndex) => (
                        <Badge 
                          key={tech} 
                          variant="outline" 
                          className="text-xs px-3 py-1 rounded-full hover:bg-primary/10 transition-colors animate-stagger-fade"
                    ...
                    <Button
                      ...
                      size="sm"
                      asChild
                      className="w-full button-ripple group-hover:scale-105 transition-all duration-300"
                    >
